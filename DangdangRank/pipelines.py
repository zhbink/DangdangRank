...
from DangdangRank.settings import MONGO_URL, MONGO_USER, MONGO_PASSWORD
...
class MongoPipeline(object):
    ...
    def open_spider(self, spider):
        uri = "mongodb://"+MONGO_USER+":"+MONGO_PASSWORD+"@"+MONGO_URL #uri = "mongodb://user1:MongoPassWd1@localhost:27017/"
